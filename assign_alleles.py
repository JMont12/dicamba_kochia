...
for line in open(in_csv, 'r'):
	...
	if line_count==0:
		...
		if R_parent[line_count]!=S_parent[line_count] and R_parent[line_count][0]==R_parent[line_count][1] and S_parent[line_count][0]==S_parent[line_count][1]:
			col_count=0
			R_alleles=[]
			S_alleles=[]
			parts=line.split(',')
